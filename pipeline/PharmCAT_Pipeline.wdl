...
task pharmcat_pipeline {
  ...
  parameter_meta {
    ...
    sample_ids: {
      description: "A comma-separated list of sample IDs.  Only applicable if you have multiple samples and only want to work on specific ones.",
      category: "input"
    }
    sample_file: {
      description: "A file containing a list of sample IDs, one sample ID per line.  Only applicable if you have multiple samples and only want to work on specific ones.",
      category: "input"
    }
    ...
    reporter_sources: {
      description: "Comma-separated list of sources to limit recommendations to: [CPIC, DPWG, FDA]",
      category: "reporter"
    }
    reporter_extended: {
      description: "Write an extended report (includes all possible genes and drugs, even if no data is available)",
      category: "reporter"
    }
    reporter_save_json: {
